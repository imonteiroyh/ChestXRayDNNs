...
class BaseModel:
    def setup_model(
        ...
        Args:
            ...
            forward (Optional[Callable]):
                Function to be executed using predict.
        ...
        self.forward = forward or self.forward_override
    ...
    def forward_override(self, batch: Tuple[torch.Tensor, torch.Tensor]) -> Tuple[torch.Tensor, torch.Tensor]:
